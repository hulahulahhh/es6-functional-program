...
//     return Array.isArray(obj) ? obj.map(deepCopy) : Object.keys(obj).reduce((data, key)=> ({...data, [key]: deepCopy(obj[key])}),{});
...
const deepCopy = (obj) => {
    ...
    return Array.isArray(obj) ? obj.map(deepCopy) : Object.keys(obj).reduce((data, key) => {
...
module.exports = { forEach, every, some, tap, unary, once, memoized, map, filter, reduce, curry, compose, deepCopy }
